            ...
            <div class="row" id="moveToTop">
                <div class="col-md-4 d-none d-lg-block">
                    ...
                    <div class="filter_types">
                            ...
                            <!--<div class="card">-->
                            <!--    <div class="card-header">-->
                            <!--        <button class="card-link" type="button" data-toggle="collapse" data-target="#service-type" aria-expanded="true">@lang('app.serviceType')</button>-->
                            <!--    </div>-->
                        ...
                        <div class="col-md-6 d-flex justify-content-end position-relative mobile-no-padding">
                            <div class="input-group">
                                ...
                                <select class="myselect apply-filter" name="sort_by" id="sort_by">
                                    ...
                                    <option value="location" id="getLocation">@lang('app.location')</option>
                                </select>
...
@push('footer-script')
    <script>
        ...
        $('body').on('click', '#pagination a', function(e) {
            ...
            var url = '{{ route("front.services", "all") }}?page='+page;
