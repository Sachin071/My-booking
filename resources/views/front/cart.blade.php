                                ...
                                <tr>
                                    <td colspan="6">
                                        <ul class="cart-buttons">
                                            ...
                                            <li>
                                                <a href="javascript:;" data-key="all" class="btn btn-custom btn-blue delete-item" style='margin-right : 5px; width : 40%;'  id="clear-cart">@lang('front.buttons.clearCart')</a>
                            ...
                            @if ($type == 'booking')
                                <div class="mx-3 mt-4 @if(is_null($couponData)) CouponBox @else d-none @endif" id="applyCouponBox">
                                    <div class="input-group">
                                        <input type="text" name="coupon" class="form-control" placeholder="Enter Coupan Code" id="coupon">
